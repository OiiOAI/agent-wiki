...
Aplysia californica is a marine snail with a simple nervous system of approximately 20,000 nerve cells used extensively to study the neuronal basis of learning, especially classical conditioning. The animal exhibits defensive reflexes including siphon and gill withdrawal that habituate rapidly but can be converted to conditioned responses through pairing with electrical shock.

## Key facts

- Aplysia has approximately 20,000 nerve cells in its abdominal ganglion, making its nervous system experimentally manageable for studying learning mechanisms. [raw/books/neuroscience/Affective Neuroscience_ The Foundations of Human and Animal - Panksepp, Jaak.pdf#p27]
- Touching the siphon or gill leads to withdrawal of these organs, but this response habituates rapidly; however, if touch (CS) is paired with electric shock to the tail (UCS), the animal develops a conditioned gill-withdrawal response. [raw/books/neuroscience/Affective Neuroscience_ The Foundations of Human and Animal - Panksepp, Jaak.pdf#p27]
...
- Inference: The successful use of Aplysia for conditioning studies demonstrates that even simple nervous systems possess endogenous behavior generators capable of being modified by reinforcement contingencies.
- Inference: The fact that instrumental conditioning required utilizing spontaneous behavioral repertoires suggests that animals are most likely to emit conditional instrumental responses by molding preexisting behavioral tendencies.

## Related pages

- Adjacent: [[classical-conditioning]]
