...
Granny's Rule is the requirement that children eat their carrots before they get dessert, demonstrating 'reward superpower' so extreme it can manipulate one's own behavior using rewards already possessed. The business version requires executives to force themselves daily to first do unpleasant and necessary tasks before rewarding themselves by proceeding to pleasant tasks. Consultants urge business organizations to improve reward systems by teaching executives to use this rule.
