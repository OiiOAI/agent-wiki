---
id: social-exercise-and-neurogenesis
title: Social Exercise and Neurogenesis
type: concept
status: draft
created: '2026-04-23'
updated: '2026-04-23'
...
# Social Exercise and Neurogenesis

## Summary

Social interaction amplifies the neurological benefits of exercise. Elizabeth Gould's research found that rodents in social groups showed significantly greater neurogenesis from running than isolated runners, even though both exercised equally. Social support blunts the reactivity of the HPA axis and prevents cortisol from interfering with neurogenesis. Both isolation and prolonged cortisol exposure reduce serotonin receptors in the hippocampus. However, over the long term (24-48 days), isolated runners' systems catch up to social group runners.
...
- Inference: The combination of exercise (which primes neural growth mechanisms) and social interaction (which provides meaningful mental stimulation to consolidate those changes) maximizes brain growth potential.

## Related pages

- Broader: [[exercise psychology]]
- Broader: [[neurogenesis]]
- Broader: [[social brain]]
- Narrower: [[serotonin]]
- Narrower: [[cortisol]]
- Narrower: [[HPA axis]]
- Adjacent: [[exercise alone]]
- Adjacent: [[stress and exercise]]
- Adjacent: [[social isolation]]
- Concepts: [[neurogenesis]]
- Concepts: [[serotonin]]
- Concepts: [[cortisol]]
- Concepts: [[social brain]]
- Concepts: [[HPA axis]]
