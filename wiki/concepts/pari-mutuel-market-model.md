---
id: pari-mutuel-market-model
title: Pari-Mutuel Market Model
type: concept
status: draft
created: '2026-04-24'
updated: '2026-04-24'
...
Munger's analogy comparing stock markets to horse racing pari-mutuel systems. Both are markets where odds change based on bets, and prices incorporate information efficiently. However, both also have inefficiencies that allow shrewd operators to find mispriced bets. The 'house take' (transaction costs) must be beaten, making consistent winning difficult but possible for disciplined investors.
...
- Inference: The model implies that investment management as a whole provides no net value to clients on average—someone must underperform for others to outperform.
