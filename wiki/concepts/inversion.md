...
A problem-solving technique where one turns problems around into reverse to think better. Munger learned from the great algebraist Jacobi's principle 'Invert, always invert.' Instead of asking 'How can I help India?', ask 'How can I hurt India?' Find what will do the worst damage, then try to avoid it. Inversion solves problems that resist normal approaches.
...
- Inference: Munger applied inversion to psychology itself—rather than cataloging successful thinking, he collected instances of bad judgment and pondered how to avoid them, using inversion to identify the psychological tendencies that cause misjudgment.
- Inference: The inversion principle connects directly to psychological objectivity—being willing to consider disconfirming evidence is essentially inverting the natural tendency to confirm existing beliefs.
