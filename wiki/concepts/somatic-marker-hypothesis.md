...
Antonio Damasio's somatic marker hypothesis proposes that feelings arise from the brain's representation of bodily responses triggered by emotional stimuli. Emotions are action programs that control innate behavioral and physiological responses nonconsciously, while feelings are conscious experiences that result from representing these body responses in body-sensing areas of the brain (somatosensory cortex, insular cortex). Damasio emphasizes feedback from the entire body including signals from skin, muscles, joints, and visceral organs. He distinguishes emotions (nonconscious action programs) from feelings (conscious experiences). More recently, Damasio has shifted emphasis from cortical to subcortical body-sensing areas in the brain stem as the primary source of basic emotional feelings.

## Key facts

- Damasio distinguishes emotions (nonconscious action programs controlling innate responses) from feelings (conscious experiences following representation of those responses in body-sensing areas). [raw/books/neuroscience/Anxious - Joseph LeDoux.pdf#p197]
- Somatic markers are signals from the body that are 'read' by somatosensory cortex, insular cortex, hypothalamus, and periaqueductal gray. [raw/books/neuroscience/Anxious - Joseph LeDoux.pdf#p198]
- The insular cortex was emphasized as a key body-sensing area for feelings, with damage to it not eliminating feelings entirely. [raw/books/neuroscience/Anxious - Joseph LeDoux.pdf#p201]
- Damasio's 'as if' loop mechanism proposes that body states can be re-created from memory without actual body feedback. [raw/books/neuroscience/Anxious - Joseph LeDoux.pdf#p201]
- The somatic marker hypothesis proposes that emotion and feeling are indispensable for rationality, pointing decision-making toward appropriate options. [raw/books/neuroscience/Descartes' error _ emotion, reason, and the human brain - Antonio R_ Damasio,pdf.pdf#p13]
- When somatic marker processing is disrupted by ventromedial prefrontal damage, patients like Elliot can know the right answer but cannot effectively decide, producing the characteristic dissociation between knowledge and action. [raw/books/neuroscience/Descartes' error _ emotion, reason, and the human brain - Antonio R_ Damasio,pdf.pdf#p69]
- Somatic markers work by tagging options in a decision-making space with emotional values derived from past experience, allowing rapid elimination of poor options. [raw/books/neuroscience/Descartes' error _ emotion, reason, and the human brain - Antonio R_ Damasio,pdf.pdf#p71]
- Emotion and feeling provide the bridge between rational and nonrational processes, and between cortical and subcortical structures in the brain. [raw/books/neuroscience/Descartes' error _ emotion, reason, and the human brain - Antonio R_ Damasio,pdf.pdf#p148]
- Somatic markers are signals from the body that help guide decision-making by marking certain options as potentially good or bad based on past experience. [raw/books/neuroscience/Descartes' error _ emotion, reason, and the human brain - Antonio R_ Damasio,pdf.pdf#p171]
- The brain uses 'as if' loops to conjure fainter images of emotional body states without reenacting them in the body proper, allowing for faster processing. [raw/books/neuroscience/Descartes' error _ emotion, reason, and the human brain - Antonio R_ Damasio,pdf.pdf#p176]
- Feelings are juxtaposed to the mental images that initiated the emotional cycle, and this juxtaposition is essential to the experience of feeling. [raw/books/neuroscience/Descartes' error _ emotion, reason, and the human brain - Antonio R_ Damasio,pdf.pdf#p165]
- Somatic markers are a special instance of feelings generated from secondary emotions that have been connected, by learning, to predicted future outcomes of certain scenarios. [raw/books/neuroscience/Descartes' error _ emotion, reason, and the human brain - Antonio R_ Damasio,pdf.pdf#p194]
- Somatic markers do not deliberate for us; they assist deliberation by highlighting some options (dangerous or favorable) and eliminating them rapidly from subsequent consideration. [raw/books/neuroscience/Descartes' error _ emotion, reason, and the human brain - Antonio R_ Damasio,pdf.pdf#p195]
...
- The somatic marker hypothesis posits that decision making relies on defective activation of somatic states (emotional signals) that attach value to options and scenarios. [raw/books/neuroscience/Neuroscience of Decision Making - Mandel, David R.,Vartanian, Oshin.pdf#p109]
- Emotional signals function as covert biases for guiding decisions. [raw/books/neuroscience/Neuroscience of Decision Making - Mandel, David R.,Vartanian, Oshin.pdf#p109]
- The ventromedial prefrontal cortex is a critical component of the neural system underlying somatic markers. [raw/books/neuroscience/Neuroscience of Decision Making - Mandel, David R.,Vartanian, Oshin.pdf#p109]
- Other neural regions including the amygdala and somatosensory cortices (SI, SII, and insula) are components of the somatic marker neural system. [raw/books/neuroscience/Neuroscience of Decision Making - Mandel, David R.,Vartanian, Oshin.pdf#p109]
- Patients deprived of emotional signals must rely on slow cost-benefit analyses of conflicting options which may be too numerous or lengthy for rapid on-line decisions. [raw/books/neuroscience/Neuroscience of Decision Making - Mandel, David R.,Vartanian, Oshin.pdf#p109]
- The somatic marker hypothesis framework proposes that emotional (somatic) states are re-enacted during decision making, with signals relayed to somatosensory and insular cortices. [raw/books/neuroscience/Neuroscience of Decision Making - Mandel, David R.,Vartanian, Oshin.pdf#p122]
...
- Inference: LeDoux agrees with Damasio that feelings are conscious manifestations of nonconscious processes but disagrees that body signals are the sole or primary determinant of what we feel.
...
- Broader: [[emotion-cognition-interaction]]
- Narrower: [[insula]]
...
- Narrower: [[iowa-gambling-task]]
- Narrower: [[body-loop]]
- Narrower: [[as-if-body-loop]]
- Narrower: [[somatic-marker]]
- Adjacent: [[damasio]]
...
- Concepts: [[feeling]]
- Concepts: [[body]]
- Concepts: [[somatic-marker]]
- Concepts: [[insula]]
- Concepts: [[dispositional-representations]]
- Concepts: [[primary-emotions]]
- Concepts: [[secondary-emotions]]
