---
id: navy-captain-model
title: Navy Captain Model
type: concept
status: draft
created: '2026-04-24'
updated: '2026-04-24'
...
A management accountability model from the U.S. Navy where a captain's career ends if his ship goes aground, regardless of fault—even if he was exhausted after being on duty for 24 hours and turned command over to a competent first mate. Munger advocates for such 'no-fault' rules in other domains.
...
- Broader: [[accountability models]]
- Broader: [[management principles]]
- Adjacent: [[pilot training model]]
- Adjacent: [[professional judgment]]
