...
Temporal discounting is a measure of impulsive choice reflecting the devaluation of rewards as the delay to their receipt increases. In temporal discounting procedures, a choice is given between a small immediate reward and a delayed larger one, with impulsive choice reflected as preference for the smaller, more immediate outcome. The resulting behavior can be modeled as a hyperbolic function. Temporal discounting is mediated by dopaminergic and serotonergic mechanisms in the nucleus accumbens and prefrontal cortex.

## Key facts

- In temporal discounting procedures, impulsive choice is reflected as preference for the smaller, more immediate outcome over the larger delayed one. [raw/books/neuroscience/Decision Neuroscience _ An Integrative Perspective - Jean - Claude Dreher; Léon Tremblay; Institut de sciences.pdf#p86]
- The resulting behavior in temporal discounting can usually be modeled as a hyperbolic function in which the constant k provides an index of temporal reward discounting. [raw/books/neuroscience/Decision Neuroscience _ An Integrative Perspective - Jean - Claude Dreher; Léon Tremblay; Institut de sciences.pdf#p86]
- Selective bilateral excitotoxic lesions of the nucleus accumbens core region result in more impulsive choice using a temporal discounting task. [raw/books/neuroscience/Decision Neuroscience _ An Integrative Perspective - Jean - Claude Dreher; Léon Tremblay; Institut de sciences.pdf#p90]
- Temporal discounting is powerfully modulated by both dopaminergic and serotoninergic influences within the nucleus accumbens and various sectors of the prefrontal cortex. [raw/books/neuroscience/Decision Neuroscience _ An Integrative Perspective - Jean - Claude Dreher; Léon Tremblay; Institut de sciences.pdf#p91]
- 5-HT1A receptor agonists antagonize the effects of D-amphetamine to reduce impulsive choice, whereas 5-HT1A antagonists potentiate it. [raw/books/neuroscience/Decision Neuroscience _ An Integrative Perspective - Jean - Claude Dreher; Léon Tremblay; Institut de sciences.pdf#p91]
- The relationship between subjective value and delay follows a hyperbolic function, meaning that delays are weighted more heavily than rational discounting based on interest rates would predict. [raw/books/neuroscience/Decision Neuroscience _ An Integrative Perspective - Jean - Claude Dreher; Léon Tremblay; Institut de sciences.pdf#p273]
...
- Uncertain: Findings on the effects of focal frontal lesions on temporal discounting are inconsistent across studies, possibly due to differences in sample size and lesion ROI definitions.
...
- Entities: [[lateral-prefrontal-cortex]]
