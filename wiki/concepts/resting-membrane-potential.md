...
The resting membrane potential is the electrical potential difference across the neuronal membrane when the cell is at rest, typically ranging from −60 mV to −70 mV. It results from the separation of charge across the cell membrane, with excess positive ions outside and negative ions inside. This charge separation is maintained because the lipid bilayer prevents ion diffusion, and the steady-state balance is maintained by passive ion flux through resting channels balanced by active transport via the Na+-K+ pump.

## Key facts

- The resting membrane potential (Vr) typically ranges from −60 mV to −70 mV in nerve cells. [raw/books/neuroscience/Eric Kandel PRINCIPLES OF NEURAL SCIENCE Sixth Edition - Eric R Kandel; John Koester; Sarah Mack; Steven Siegelbaum.pdf#p239]
...
- Inference: The resting membrane potential is not an equilibrium state but a steady state where passive ion fluxes through resting channels are exactly balanced by active transport via the Na+-K+ pump.
