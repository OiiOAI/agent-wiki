...
source_kind: book
source_path: raw/books/productivity/How to Take Smart Notes_ One Simple Technique
  to Boost - Sönke Ahrens.pdf
source_date: '2017'
...
This book presents the slip-box (Zettelkasten) method developed by sociologist Niklas Luhmann as a holistic note-taking and writing workflow. It argues that the quality of academic writing depends less on innate intelligence than on self-discipline and the organization of everyday writing work. The core insight is that writing should be treated not as a linear task beginning with a blank page, but as an integrated process of reading, note-taking, and idea development that builds a critical mass of interconnected notes over time. The book covers the four underlying principles (writing matters, simplicity, no blank pages, letting work carry forward) and the six practical steps from fleeting notes through to publication.
...
- Inference: The book's main argument is that improving note-taking organization is the single highest-leverage change a knowledge worker can make, because it reduces reliance on willpower (a limited resource) and builds a compounding asset of interconnected ideas over time.

## Related pages

- Broader: [[productivity]]
- Broader: [[academic writing]]
- Broader: [[note-taking methods]]
- Narrower: [[slip-box]]
- Narrower: [[luhmann-niklas]]
- Narrower: [[ahrens-soenke]]
- Narrower: [[fleeting-notes]]
- Narrower: [[permanent-notes]]
- Narrower: [[project-notes]]
- Narrower: [[ego-depletion]]
- Narrower: [[zeigarnik-effect]]
- Narrower: [[confirmation-bias]]
- Narrower: [[attention-focusing]]
- Narrower: [[growth-mindset]]
- Narrower: [[deliberate-practice]]
- Narrower: [[writing-step-by-step]]
- Adjacent: [[getting-things-done]]
- Adjacent: [[flow-state]]
- Adjacent: [[external-scaffolding]]
- Adjacent: [[critical-mass-notes]]
